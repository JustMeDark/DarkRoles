...
namespace DarkRoles
{
    ...
    {
        private static readonly string DENY_NAME_LIST_PATH = @"./DARK_ROLES_DATA/DenyName.txt";
        private static readonly string BAN_LIST_PATH = @"./DARK_ROLES_DATA/BanList.txt";

        [PluginModuleInitializer]
        public static void Init()
        {
            Directory.CreateDirectory("DARK_ROLES_DATA");
